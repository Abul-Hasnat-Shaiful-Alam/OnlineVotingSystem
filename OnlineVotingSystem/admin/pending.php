...
include_once('../db.php');
ses_chk();
if(isset($_GET['id'])){ $gid=$_GET['id']; mysql_query("UPDATE voter SET flag='1' WHERE id='$gid'"); echo 'Activated<br>'; }
...
$qry=mysql_query("SELECT * FROM voter WHERE flag='0'");
...
$id=$row['id'];
	...
	<td><a href='pending.php?id=$id'>Active</a></td>
	</tr>";	
